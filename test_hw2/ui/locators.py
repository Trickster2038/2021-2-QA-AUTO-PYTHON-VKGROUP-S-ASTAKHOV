...
class BasePageLocators:
    ...
    UNSUPPORTED_LOGIN_NOTICE = (
        By.XPATH, "//div[starts-with(@class,'notify')]")

    TAB_CAMPAIGN = (
        By.XPATH, "//a[contains(@class,'center-module-campaigns')]")
    TAB_SEGMENTS = (By.XPATH, "//a[contains(@class,'center-module-segments')]")
...
class CampaignPageLocators(BasePageLocators):
    ...
    COVERAGE_ADVERTISE = (
        By.XPATH, "//div[contains(@class,'column-list-item _reach')]")
    ...
    ADDRESS_SUBMIT = (
        By.XPATH, "//div[contains(@class,'bubbleComponent-module-submit')]")
    ...
    CAMPAIGN_BUDGET_PER_DAY = (
        By.CSS_SELECTOR, 'input[data-test="budget-per_day"]')
...
class SegmentPageLocators(BasePageLocators):
    ...
    NEW_SEGMENT_BTN = (By.CLASS_NAME, "button_submit")

    SEGMENT_SOURCE_PAYED_N_PLAYED = (
        By.CLASS_NAME, "adding-segments-source__checkbox")

    SUBMIT_SOURCE_BTN = (
        By.XPATH, "//button[not(@hidden) and contains(@class, 'button_submit') and not(@disabled)]")

    SEGMENT_NAME_INPUT = (
        By.CSS_SELECTOR, ".input_create-segment-form > * > input")

    SUBMIT_SEGMENT = (By.CLASS_NAME, "button_submit")

    CONFIRM_DELETE = (By.CLASS_NAME, "button_confirm-remove")
